export default class {
				...
				<div class="breif-right">
                    ...
                    <div class="stat">
                        ...
                        <div class="rating-total">
                            <span class="stat-number">${data.item_rating.rating_total}</span>
                            <span class="stat-name">Đánh Giá</span>
                        </div>
                        <div class="sold">
                            <span class="stat-number">${data.historical_sold}</span>
                    ...
                    <div class="infomation">
                        ...
                        ${
                            data.tier_variations[0].name === ""
                                ? ""
                                : `<div class="models">
                            <span class="title">${data.tier_variations[0].name}</span>
    ...
    main() {
        ...
        this.getProduct().then(data => {
            document.querySelector(".container__product").innerHTML = this.renderProduct(data);
            ...
            Array.from(document.querySelector(".image-slider").children).forEach(child =>
                child.addEventListener("mouseover", () => {
                    document.querySelector(".image-slider img[active]").removeAttribute("active");
                    ...
                    child.addEventListener("click", () => {
                        if (!child.classList.contains("active")) {
                            ...
                            document.querySelector(".price .price-before-discount") &&
                                (document.querySelector(".price .price-before-discount").innerText =
                                    "₫" + format(model.price_before_discount));
            ...
            quantityInput.addEventListener("input", () => {
                let stock = Number(document.querySelector(".add-product .stock-number").innerText);
            ...
            prevBtn.addEventListener("click", () => this.prevList(list, prevBtn, nextBtn));
            nextBtn.addEventListener("click", () => this.nextList(list, prevBtn, nextBtn));
        });
    }
}
